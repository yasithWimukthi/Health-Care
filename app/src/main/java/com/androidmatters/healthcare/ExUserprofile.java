...
public class ExUserprofile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ex_userprofile);
        ...
        update = findViewById(R.id.updateDoctorBtn);
        ...
        db.whereEqualTo("patientId",uid).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ExUserprofile.this, "error"+e, Toast.LENGTH_SHORT).show();
            }
        });
                             ...
                             db.document(FirebaseAuth.getInstance().getCurrentUser().getEmail())
                                     ...
                                     .addOnSuccessListener(new OnSuccessListener() {
                                         ...
                                         public void onSuccess(Object o) {
                                             ...
                                             Toast.makeText(ExUserprofile.this, "Profile Image Updated", Toast.LENGTH_SHORT).show();
                                         }
                                     }).addOnFailureListener(new OnFailureListener() {
                                 @Override
                                 public void onFailure(@NonNull Exception e) {
